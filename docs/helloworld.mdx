...
You may obtain a rearranged scene due to platform-specific library versions. On some platforms, the scenes are sometimes not 100% deterministic. This is a known issue that we are looking into.
...
- add `--debug` to generate.py or manage_datagen_jobs for more detailed logs in stdout. Include these logs in your report.
- Include your compute platform:
  - Operating System
  - Memory
