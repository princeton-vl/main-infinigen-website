...
Please check the [Github issues page](https://github.com/princeton-vl/infinigen/issues)

Add `--debug` to generate.py or manage_datagen_jobs for more detailed logs. Please include these logs when creating issues on Github.
