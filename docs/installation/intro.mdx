...
Instruction for compiling Infinigen on a MacOS system.
...
If you got errors related to LLVM, please consider uninstall Xcode Command Line Tools and then reinstall LLVM using Homebrew.
