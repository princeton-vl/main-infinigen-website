...
Uninstall Xcode Command Tools

```
sudo rm -rf /Library/Developer/CommandLineTools
```

Uninstall homebrew LLVM

```
brew uninstall llvm
```

(Optional, but may help) Run:

```
brew doctor and brew cleanup
```
...
The first time running install.sh, a window may pop up asking you to install command line tools. Click yes.
