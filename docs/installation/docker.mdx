...
## Windows
Ensure that you have correctly set up and configued the WSL2 environment as decsribed in the [Windows setup instructions](./intro#setup-for-windows.mdx)
...
In Docker Desktop, you should see that there is now an active container named "nfinigen. Run
