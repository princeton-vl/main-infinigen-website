---
id: "Exporting individual assets"
sidebar_label: "Exporting Individual Assets"
sidebar_position: 5
slug: export
---
...
In ```/infinigen/worldgen/tools/export/```, install Blender 3.6 by running 

```
bash install.sh
```
:::caution Note
We install a separate instance of Blender because Blender 3.6 has vastly improved auto-UV unwrapping. You can run this script on other Blender versions, but the export may fail on meshes with complex UV unwraps such as bushes or snakes.
:::
