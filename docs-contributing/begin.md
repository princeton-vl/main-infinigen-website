...
- **Contributing pre-generated data**. Procedural generation of 3D assets and rendering of images can be computationally expensive. It can cost several hours of GPU time to generate and render one scene. Fortunately, pre-computed data can be shared and re-used easily. Please stay for a repository of pre-generated data.
